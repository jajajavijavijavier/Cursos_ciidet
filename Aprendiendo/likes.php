...
<head>
   ...
   <title>Me gustas del video</title>
...
<section class="liked-videos">
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Ver video</a>
